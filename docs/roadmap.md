...
| T2 | A stranger reaches a live value: examples, template project, documentation site, SensESP migration guide, tutorials | done (v0.7.x) |
| T3 | Platform spine: `espos_net` (Ethernet, static IP), `espos_time` (SNTP, delta timestamps), TLS trust store (TOFU / private CA, `sk.scheme auto`), REST authentication | in progress |
